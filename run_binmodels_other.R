#CARMEN
##Created 6/10/24
###1. Running model without race/etnicity variables (d= 15)
# Load libraries
library(BayesBinMix)
library(foreach)
...
censusdata_bin <- readRDS("./Data/censusdata_bin_noraceeth_061024.rds")
...
censusdata_bin2 <- readRDS("./Data/censusdata_bin_raceeth_042524.rds")
