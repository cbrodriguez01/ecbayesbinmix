...
##Find census tracts for which the maximum probability of assignment is less than 50 for further exploration-- 83
ctslw50<-classificationprobs_10 %>% filter(maxProb < 0.5) 

#Prep Data
classificationprobs_10$ClusterAssignment_final<- factor(classificationprobs_10$ClusterAssignment_temp, levels = 1:9, labels = paste0("cluster", 1:9, sep= " "))
...
##Exploration of the 83 census tracts with prob < 0.5

ctslw50 %>%  ggplot(aes(x = as.factor(ClusterAssignment_temp), y = maxProb, fill = as.factor(ClusterAssignment_temp))) +
  geom_boxplot() +
  labs(fill = "Cluster Assignment", 
...
p_10_group2<-plot_thetakj_group(prob_est_long = dat_10,color_palette = group_cols, fig_title, numR = 5,numC = 2)
...
png("/Users/carmenrodriguez/Desktop/Research Projects/BayesBinMix/ecbayesbinmix/Figures/barplot10_18vars_top.png", width = 760, height = 886)
 p_10_group
dev.off()
