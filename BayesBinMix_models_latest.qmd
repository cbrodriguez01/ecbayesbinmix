...
res_acs10<-res_all[[1]][["res_acs10_deltatemp2"]]
res_acs15<-res_all[[1]][["res_acs15_deltatemp2"]]
res_acs19<-res_all[[1]][["res_acs19_deltatemp2"]]
```
...
#12 census tracts that are not classified based on highest prob
...
##This is odd-- my understanding is that these algorithms assigned observations to clusters probabilistically based on the highest posterior probabilities of cluster assignments given the observed data-- it seems like a rounding issue because it makes the correct assignment when none of the probabilities have similar/same leading number.

#Prep Data
classificationprobs_10$GEOID<-row.names(censusdata_bin$acs5_2010_bin)

####Find census tracts that are missclassified
...
table1::table1(~  age_median + age_20_24 + age_25_34 + age_35_44 + age_45_54 + age_55_59 + age_60_64 + age_65_74 + age_75_84 + age_85_more |ClusterAssignment, data= merged10, overall = F)
...
table1::table1(~  age_median + age_20_24 + age_25_34 + age_35_44 + age_45_54 + age_55_59 + age_60_64 + age_65_74 + age_75_84 + age_85_more |ClusterAssignment, data= merged15, overall = F)
...
classificationprobs_19$ClusterAssignment<- 
  factor(classificationprobs_19$ClusterAssignment, levels = 1:7, labels = paste0("cluster", 1:7, sep= " "))
...
table1::table1(~  age_median + age_20_24 + age_25_34 + age_35_44 + age_45_54 + age_55_59 + age_60_64 + age_65_74 + age_75_84 + age_85_more|ClusterAssignment, data= merged19, overall = F)
...
```{r}
boxplot19<-merged19%>%  ggplot(aes(x = ClusterAssignment, y = maxProb, fill = ClusterAssignment)) +
  geom_boxplot() +
  labs(fill = "Cluster Assignment", 
       y = "Assignment Probability after ECR algorithm", 
       x= "")
