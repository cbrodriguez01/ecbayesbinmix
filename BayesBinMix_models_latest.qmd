...
p_10_group2<-plot_thetakj_group(prob_est_long = dat_10, mapK,color_palette = group_cols, fig_title, numR = 5,numC = 2)
...
check<-acs10bin %>% select(medianincome_2010,ClusterAssignment)
