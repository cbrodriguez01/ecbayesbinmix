...
boxplot10
dattable<- merged10 %>% filter(maxProb > 0.5) %>% rename(`Assignment Probability` = maxProb,
...
flags_boxplot<-ctslw50 %>%  ggplot(aes(x = as.factor(ClusterAssignment_temp), y = maxProb, fill = as.factor(ClusterAssignment_temp))) +
  geom_boxplot() +
  labs(fill = "Cluster Assignment", 
