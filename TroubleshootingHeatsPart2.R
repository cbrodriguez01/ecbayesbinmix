...
# datraw<-read.table(file = "/Users/carmenrodriguez/Desktop/temp/acs10_2024-04-11_deltatemp1/rawMCMC.mapK.2.txt", header = T)
# 
...
# datraw %>% ggplot(aes(x=iteration, y = raw.mix.prop, col = as.factor(Component))) + geom_point()
# 
# 
# #(3) Reordered by STEPHENS algorithm
# reordered<-read.table(file = "/Users/carmenrodriguez/Desktop/temp/acs10_2024-04-11_deltatemp1/reorderedMCMC-ECR.mapK.2.txt", header = T)
# 
...
# reorderedp %>% ggplot(aes(x=iteration, y = reordered.mix.prop, col = as.factor(Component))) + geom_point()
# 
# 
# 
